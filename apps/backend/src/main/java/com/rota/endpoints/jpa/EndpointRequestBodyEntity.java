...
/** Maps the {@code endpoint_request_bodies} table (one row per content type). */
@Entity
@Table(name = "endpoint_request_bodies")
@EntityListeners(AuditEntityListener.class)
@Auditable(type = "endpoint_request_body", fields = {"contentType"})
public class EndpointRequestBodyEntity {
