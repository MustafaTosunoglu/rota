...
/** Maps {@code consumer_group_endpoint_access}: endpoint-level override of the document grant. */
@Entity
@Table(name = "consumer_group_endpoint_access")
@EntityListeners(AuditEntityListener.class)
@Auditable(type = "consumer_group_endpoint_access", fields = {"canView", "canTry", "canLoadtest"})
public class GroupEndpointAccessEntity {
