  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        ...
        'focus-visible:ring-2 focus-visible:ring-ring/50 focus:outline-none disabled:pointer-events-none disabled:opacity-50',
...
function TabsContent({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Content>) {
  return (
    <TabsPrimitive.Content
      className={cn('mt-4 focus-visible:ring-2 focus-visible:ring-ring/50 focus:outline-none', className)}
      {...props}
    />
  )
}
